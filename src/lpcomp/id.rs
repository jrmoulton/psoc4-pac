...
#[doc = "Field `ID` reader - the ID of LPCOMP peripheral is 0xE0E0"]
...
impl R {
    #[doc = "Bits 0:15 - the ID of LPCOMP peripheral is 0xE0E0"]
    #[inline(always)]
    pub fn id(&self) -> ID_R {
...
#[doc = "`reset()` method sets ID to value 0x0001_e0e0"]
