...
#[doc = "Field `TIMER` reader - Write INTR_SET field with '1' to set corresponding INTR field."]
pub type TIMER_R = crate::BitReader<bool>;
#[doc = "Field `TIMER` writer - Write INTR_SET field with '1' to set corresponding INTR field."]
pub type TIMER_W<'a> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, 0>;
impl R {
    #[doc = "Bit 0 - Write INTR_SET field with '1' to set corresponding INTR field."]
    #[inline(always)]
