...
#[doc = "Field `TIMER` reader - Mask for corresponding field in INTR register."]
pub type TIMER_R = crate::BitReader<bool>;
#[doc = "Field `TIMER` writer - Mask for corresponding field in INTR register."]
pub type TIMER_W<'a> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, 0>;
impl R {
