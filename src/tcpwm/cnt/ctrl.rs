...
pub type AUTO_RELOAD_CC_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 0>;
...
pub type AUTO_RELOAD_PERIOD_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 1>;
...
pub type PWM_SYNC_KILL_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 2>;
...
pub type PWM_STOP_ON_KILL_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 3>;
...
pub type GENERIC_W<'a> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, u8, 8, 8>;
#[doc = "Determines counter direction.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum UP_DOWN_MODE_A {
    #[doc = "0: Count up (to PERIOD). An overflow event is generated when the counter reaches PERIOD. A terminal count event is generated when the counter reaches PERIOD."]
    COUNT_UP = 0,
    #[doc = "1: Count down (to '0'). An underflow event is generated when the counter reaches '0'. A terminal count event is generated when the counter reaches '0'."]
    COUNT_DOWN = 1,
    #[doc = "2: Count up (to PERIOD), then count down (to '0'). An overflow event is generated when the counter reaches PERIOD. An underflow event is generated when the counter reaches '0'. A terminal count event is generated when the counter reaches '0'."]
    COUNT_UPDN1 = 2,
...
pub type UP_DOWN_MODE_W<'a> = crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, UP_DOWN_MODE_A, 2, 16>;
impl<'a> UP_DOWN_MODE_W<'a> {
    #[doc = "Count up (to PERIOD). An overflow event is generated when the counter reaches PERIOD. A terminal count event is generated when the counter reaches PERIOD."]
    #[inline(always)]
    pub fn count_up(self) -> &'a mut W {
        self.variant(UP_DOWN_MODE_A::COUNT_UP)
    }
    #[doc = "Count down (to '0'). An underflow event is generated when the counter reaches '0'. A terminal count event is generated when the counter reaches '0'."]
    #[inline(always)]
    pub fn count_down(self) -> &'a mut W {
        self.variant(UP_DOWN_MODE_A::COUNT_DOWN)
    }
    #[doc = "Count up (to PERIOD), then count down (to '0'). An overflow event is generated when the counter reaches PERIOD. An underflow event is generated when the counter reaches '0'. A terminal count event is generated when the counter reaches '0'."]
    #[inline(always)]
...
pub type ONE_SHOT_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 18>;
...
and a disabled output line 'dt_line_compl_out' has the value QUADRATURE_MODE\\[1\\]."]
pub type QUADRATURE_MODE_W<'a> =
    crate::FieldWriter<'a, u32, CTRL_SPEC, u8, QUADRATURE_MODE_A, 2, 20>;
...
pub type MODE_W<'a> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, MODE_A, 3, 24>;
impl<'a> MODE_W<'a> {
    #[doc = "Timer mode"]
    #[inline(always)]
