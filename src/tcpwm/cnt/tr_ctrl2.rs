...
pub type CC_MATCH_MODE_W<'a> =
    crate::FieldWriterSafe<'a, u32, TR_CTRL2_SPEC, u8, CC_MATCH_MODE_A, 2, 0>;
...
pub type OVERFLOW_MODE_W<'a> =
    crate::FieldWriterSafe<'a, u32, TR_CTRL2_SPEC, u8, OVERFLOW_MODE_A, 2, 2>;
...
pub type UNDERFLOW_MODE_W<'a> =
    crate::FieldWriterSafe<'a, u32, TR_CTRL2_SPEC, u8, UNDERFLOW_MODE_A, 2, 4>;
