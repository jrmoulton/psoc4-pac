...
#[doc = "Field `CAPTURE_SEL` reader - Selects one of the 16 input triggers as a capture trigger. Input trigger 0 is always '0' and input trigger 1 is always '1'. Input trigger 2 is the first external trigger line (tcpwm.tr_in\\[0\\]). In the PWM, PWM_DT and PWM_PR modes this trigger is used to switch the values if the compare and period registers with their buffer counterparts."]
pub type CAPTURE_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CAPTURE_SEL` writer - Selects one of the 16 input triggers as a capture trigger. Input trigger 0 is always '0' and input trigger 1 is always '1'. Input trigger 2 is the first external trigger line (tcpwm.tr_in\\[0\\]). In the PWM, PWM_DT and PWM_PR modes this trigger is used to switch the values if the compare and period registers with their buffer counterparts."]
pub type CAPTURE_SEL_W<'a> = crate::FieldWriter<'a, u32, TR_CTRL0_SPEC, u8, u8, 4, 0>;
...
pub type COUNT_SEL_W<'a> = crate::FieldWriter<'a, u32, TR_CTRL0_SPEC, u8, u8, 4, 4>;
...
pub type RELOAD_SEL_W<'a> = crate::FieldWriter<'a, u32, TR_CTRL0_SPEC, u8, u8, 4, 8>;
...
pub type STOP_SEL_W<'a> = crate::FieldWriter<'a, u32, TR_CTRL0_SPEC, u8, u8, 4, 12>;
...
pub type START_SEL_W<'a> = crate::FieldWriter<'a, u32, TR_CTRL0_SPEC, u8, u8, 4, 16>;
impl R {
    #[doc = "Bits 0:3 - Selects one of the 16 input triggers as a capture trigger. Input trigger 0 is always '0' and input trigger 1 is always '1'. Input trigger 2 is the first external trigger line (tcpwm.tr_in\\[0\\]). In the PWM, PWM_DT and PWM_PR modes this trigger is used to switch the values if the compare and period registers with their buffer counterparts."]
    #[inline(always)]
