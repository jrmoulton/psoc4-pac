...
pub type COUNTER_INT_R = crate::FieldReader<u8, u8>;
impl R {
    #[doc = "Bits 0:7 - Counters interrupt signal active. If the counter is disabled through CTRL.COUNTER_ENABLED, the associated interrupt field is immediately set to '0'."]
    #[inline(always)]
    pub fn counter_int(&self) -> COUNTER_INT_R {
        COUNTER_INT_R::new((self.bits & 0xff) as u8)
    }
}
