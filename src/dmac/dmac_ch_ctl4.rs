#[doc = "Register `DMAC_CH_CTL4` reader"]
pub struct R(crate::R<DMAC_CH_CTL4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMAC_CH_CTL4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMAC_CH_CTL4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMAC_CH_CTL4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DMAC_CH_CTL4` writer"]
pub struct W(crate::W<DMAC_CH_CTL4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMAC_CH_CTL4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMAC_CH_CTL4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMAC_CH_CTL4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ENABLED_W<'a> = crate::BitWriter<'a, u32, DMAC_CH_CTL4_SPEC, ENABLED_A, 31>;
impl<'a> ENABLED_W<'a> {
...
pub type PING_PONG_W<'a> = crate::BitWriter<'a, u32, DMAC_CH_CTL4_SPEC, PING_PONG_A, 30>;
...
pub type PRIO_W<'a> = crate::FieldWriter<'a, u32, DMAC_CH_CTL4_SPEC, u8, u8, 2, 28>;
impl R {
...
#[doc = "DMA channel 4 control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dmac_ch_ctl4](index.html) module"]
pub struct DMAC_CH_CTL4_SPEC;
impl crate::RegisterSpec for DMAC_CH_CTL4_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dmac_ch_ctl4::R](R) reader structure"]
impl crate::Readable for DMAC_CH_CTL4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dmac_ch_ctl4::W](W) writer structure"]
impl crate::Writable for DMAC_CH_CTL4_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DMAC_CH_CTL4 to value 0"]
impl crate::Resettable for DMAC_CH_CTL4_SPEC {
    #[inline(always)]
