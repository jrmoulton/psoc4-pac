...
pub type HSCMP_EN_W<'a> = crate::BitWriter<'a, u32, HSCMP_SPEC, HSCMP_EN_A, 0>;
impl<'a> HSCMP_EN_W<'a> {
...
pub type HSCMP_INVERT_W<'a> = crate::BitWriter<'a, u32, HSCMP_SPEC, bool, 4>;
...
pub type AZ_EN_W<'a> = crate::BitWriter<'a, u32, HSCMP_SPEC, bool, 31>;
impl R {
