...
pub type SW_HCAV_W<'a> = crate::FieldWriter<'a, u32, SW_SHIELD_SEL_SPEC, u8, u8, 3, 0>;
...
pub type SW_HCAG_W<'a> = crate::FieldWriter<'a, u32, SW_SHIELD_SEL_SPEC, u8, u8, 3, 4>;
#[doc = "Field `SW_HCBV` reader - N/A"]
pub type SW_HCBV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SW_HCBV` writer - N/A"]
pub type SW_HCBV_W<'a> = crate::FieldWriter<'a, u32, SW_SHIELD_SEL_SPEC, u8, u8, 3, 8>;
...
pub type SW_HCBG_W<'a> = crate::FieldWriter<'a, u32, SW_SHIELD_SEL_SPEC, u8, u8, 3, 12>;
...
pub type SW_HCCV_W<'a> = crate::BitWriter<'a, u32, SW_SHIELD_SEL_SPEC, bool, 16>;
...
pub type SW_HCCG_W<'a> = crate::BitWriter<'a, u32, SW_SHIELD_SEL_SPEC, bool, 20>;
impl R {
    #[doc = "Bits 0:2 - N/A"]
    #[inline(always)]
