...
pub type VAL_W<'a> = crate::FieldWriter<'a, u32, IDACB_SPEC, u8, u8, 7, 0>;
...
pub type POL_DYN_W<'a> = crate::BitWriter<'a, u32, IDACB_SPEC, POL_DYN_A, 7>;
impl<'a> POL_DYN_W<'a> {
...
pub type POLARITY_W<'a> = crate::FieldWriterSafe<'a, u32, IDACB_SPEC, u8, POLARITY_A, 2, 8>;
impl<'a> POLARITY_W<'a> {
...
pub type BAL_MODE_W<'a> = crate::FieldWriterSafe<'a, u32, IDACB_SPEC, u8, BAL_MODE_A, 2, 10>;
impl<'a> BAL_MODE_W<'a> {
    #[doc = "same as corresponding IDACA Balancing mode"]
    #[inline(always)]
...
pub type LEG1_MODE_W<'a> = crate::FieldWriterSafe<'a, u32, IDACB_SPEC, u8, LEG1_MODE_A, 2, 16>;
...
pub type LEG2_MODE_W<'a> = crate::FieldWriterSafe<'a, u32, IDACB_SPEC, u8, LEG2_MODE_A, 2, 18>;
...
pub type DSI_CTRL_EN_W<'a> = crate::BitWriter<'a, u32, IDACB_SPEC, bool, 21>;
#[doc = "IDAC multiplier\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum RANGE_A {
...
pub type RANGE_W<'a> = crate::FieldWriter<'a, u32, IDACB_SPEC, u8, RANGE_A, 2, 22>;
impl<'a> RANGE_W<'a> {
    #[doc = "1 LSB = 37.5 nA"]
    #[inline(always)]
...
pub type LEG1_EN_W<'a> = crate::BitWriter<'a, u32, IDACB_SPEC, bool, 24>;
...
pub type LEG2_EN_W<'a> = crate::BitWriter<'a, u32, IDACB_SPEC, bool, 25>;
...
pub type LEG3_EN_W<'a> = crate::BitWriter<'a, u32, IDACB_SPEC, bool, 26>;
impl R {
