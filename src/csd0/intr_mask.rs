...
pub type SAMPLE_W<'a> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, 1>;
...
pub type INIT_W<'a> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, 2>;
...
pub type ADC_RES_W<'a> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, 8>;
impl R {
