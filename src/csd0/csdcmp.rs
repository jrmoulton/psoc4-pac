...
pub type CSDCMP_EN_W<'a> = crate::BitWriter<'a, u32, CSDCMP_SPEC, CSDCMP_EN_A, 0>;
...
pub type POLARITY_SEL_W<'a> = crate::FieldWriter<'a, u32, CSDCMP_SPEC, u8, POLARITY_SEL_A, 2, 4>;
...
#[doc = "Field `CMP_PHASE` reader - Select in what phase(s) the comparator is active. Note, this also determines when a bad conversion is detected, namely at the beginning and end of the comparator active phase (also taking into account FILTER_DELAY and non-overlap)."]
...
#[doc = "Field `CMP_PHASE` writer - Select in what phase(s) the comparator is active. Note, this also determines when a bad conversion is detected, namely at the beginning and end of the comparator active phase (also taking into account FILTER_DELAY and non-overlap)."]
pub type CMP_PHASE_W<'a> = crate::FieldWriterSafe<'a, u32, CSDCMP_SPEC, u8, CMP_PHASE_A, 2, 8>;
...
pub type CMP_MODE_W<'a> = crate::BitWriter<'a, u32, CSDCMP_SPEC, CMP_MODE_A, 28>;
impl<'a> CMP_MODE_W<'a> {
...
pub type FEEDBACK_MODE_W<'a> = crate::BitWriter<'a, u32, CSDCMP_SPEC, FEEDBACK_MODE_A, 29>;
...
pub type AZ_EN_W<'a> = crate::BitWriter<'a, u32, CSDCMP_SPEC, bool, 31>;
impl R {
    ...
    #[doc = "Bits 8:9 - Select in what phase(s) the comparator is active. Note, this also determines when a bad conversion is detected, namely at the beginning and end of the comparator active phase (also taking into account FILTER_DELAY and non-overlap)."]
    #[inline(always)]
