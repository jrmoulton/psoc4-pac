...
#[doc = "Field `SAMPLE` reader - A normal sample is complete (CSDv1 compatible interrupt)"]
pub type SAMPLE_R = crate::BitReader<bool>;
#[doc = "Field `SAMPLE` writer - A normal sample is complete (CSDv1 compatible interrupt)"]
pub type SAMPLE_W<'a> = crate::BitWriter<'a, u32, INTR_SPEC, bool, 1>;
...
pub type INIT_W<'a> = crate::BitWriter<'a, u32, INTR_SPEC, bool, 2>;
...
pub type ADC_RES_W<'a> = crate::BitWriter<'a, u32, INTR_SPEC, bool, 8>;
impl R {
    #[doc = "Bit 1 - A normal sample is complete (CSDv1 compatible interrupt)"]
    #[inline(always)]
