...
#[doc = "Field `CSD_CHARGE` reader - Qualified, and possible inverted value of COMP_OUT that is used to drive GPIO's charging Cmod or Csh_tank."]
pub type CSD_CHARGE_R = crate::BitReader<bool>;
...
impl R {
    #[doc = "Bit 0 - Qualified, and possible inverted value of COMP_OUT that is used to drive GPIO's charging Cmod or Csh_tank."]
    #[inline(always)]
    pub fn csd_charge(&self) -> CSD_CHARGE_R {
        CSD_CHARGE_R::new((self.bits & 1) != 0)
    }
