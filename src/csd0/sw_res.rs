...
pub type RES_HCAV_W<'a> = crate::FieldWriterSafe<'a, u32, SW_RES_SPEC, u8, RES_HCAV_A, 2, 0>;
impl<'a> RES_HCAV_W<'a> {
    #[doc = "Low"]
    #[inline(always)]
...
pub type RES_HCAG_W<'a> = crate::FieldWriter<'a, u32, SW_RES_SPEC, u8, u8, 2, 2>;
...
pub type RES_HCBV_W<'a> = crate::FieldWriter<'a, u32, SW_RES_SPEC, u8, u8, 2, 4>;
...
pub type RES_HCBG_W<'a> = crate::FieldWriter<'a, u32, SW_RES_SPEC, u8, u8, 2, 6>;
...
pub type RES_F1PM_W<'a> = crate::FieldWriterSafe<'a, u32, SW_RES_SPEC, u8, RES_F1PM_A, 2, 16>;
impl<'a> RES_F1PM_W<'a> {
    #[doc = "Low"]
    #[inline(always)]
    pub fn low(self) -> &'a mut W {
...
pub type RES_F2PT_W<'a> = crate::FieldWriter<'a, u32, SW_RES_SPEC, u8, u8, 2, 18>;
impl R {
