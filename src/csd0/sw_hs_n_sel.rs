...
pub type SW_HCCC_W<'a> = crate::BitWriter<'a, u32, SW_HS_N_SEL_SPEC, bool, 16>;
...
pub type SW_HCCD_W<'a> = crate::BitWriter<'a, u32, SW_HS_N_SEL_SPEC, bool, 20>;
...
pub type SW_HCRH_W<'a> = crate::FieldWriter<'a, u32, SW_HS_N_SEL_SPEC, u8, u8, 3, 24>;
...
pub type SW_HCRL_W<'a> = crate::FieldWriter<'a, u32, SW_HS_N_SEL_SPEC, u8, u8, 3, 28>;
impl R {
