...
#[doc = "Field `CONV_CNT` reader - Number of conversion per sample, if set to 0 the Sample_init state will be skipped."]
pub type CONV_CNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CONV_CNT` writer - Number of conversion per sample, if set to 0 the Sample_init state will be skipped."]
pub type CONV_CNT_W<'a> = crate::FieldWriter<'a, u32, SEQ_INIT_CNT_SPEC, u16, u16, 16, 0>;
impl R {
    #[doc = "Bits 0:15 - Number of conversion per sample, if set to 0 the Sample_init state will be skipped."]
    #[inline(always)]
