...
(for LUTs 0, 1, 2, 3); io_data_in\\[7\\]
(for LUTs 4, 5, 6, 7)."]
pub type LUT_TR0_SEL_W<'a> = crate::FieldWriter<'a, u32, LUT_SEL_SPEC, u8, u8, 4, 0>;
...
(for LUTs 0, 1, 2, 3); io_data_in\\[7\\]
(for LUTs 4, 5, 6, 7)."]
pub type LUT_TR1_SEL_W<'a> = crate::FieldWriter<'a, u32, LUT_SEL_SPEC, u8, u8, 4, 8>;
...
pub type LUT_TR2_SEL_W<'a> = crate::FieldWriter<'a, u32, LUT_SEL_SPEC, u8, u8, 4, 16>;
impl R {
