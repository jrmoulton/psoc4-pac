...
pub type LS_EN_W<'a> = crate::BitWriter<'a, u32, CONTROL_SPEC, bool, 0>;
...
pub type HS_EN_W<'a> = crate::BitWriter<'a, u32, CONTROL_SPEC, bool, 1>;
...
pub type LCD_MODE_W<'a> = crate::BitWriter<'a, u32, CONTROL_SPEC, LCD_MODE_A, 2>;
impl<'a> LCD_MODE_W<'a> {
...
pub type TYPE_W<'a> = crate::BitWriter<'a, u32, CONTROL_SPEC, TYPE_A, 3>;
impl<'a> TYPE_W<'a> {
...
pub type OP_MODE_W<'a> = crate::BitWriter<'a, u32, CONTROL_SPEC, OP_MODE_A, 4>;
impl<'a> OP_MODE_W<'a> {
    #[doc = "PWM Mode"]
    #[inline(always)]
...
pub type BIAS_W<'a> = crate::FieldWriterSafe<'a, u32, CONTROL_SPEC, u8, BIAS_A, 2, 5>;
impl<'a> BIAS_W<'a> {
    #[doc = "1/2 Bias"]
    #[inline(always)]
...
pub type COM_NUM_W<'a> = crate::FieldWriter<'a, u32, CONTROL_SPEC, u8, u8, 4, 8>;
