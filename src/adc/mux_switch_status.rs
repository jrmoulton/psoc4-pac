...
#[doc = "Register `MUX_SWITCH_STATUS` writer"]
pub struct W(crate::W<MUX_SWITCH_STATUS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MUX_SWITCH_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MUX_SWITCH_STATUS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MUX_SWITCH_STATUS_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [mux_switch_status::W](W) writer structure"]
impl crate::Writable for MUX_SWITCH_STATUS_SPEC {
    type Writer = W;
}
