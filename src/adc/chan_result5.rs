#[doc = "Register `CHAN_RESULT5` reader"]
pub struct R(crate::R<CHAN_RESULT5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHAN_RESULT5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHAN_RESULT5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHAN_RESULT5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CHAN_RESULT5` writer"]
pub struct W(crate::W<CHAN_RESULT5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CHAN_RESULT5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CHAN_RESULT5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CHAN_RESULT5_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Channel5 result data register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [chan_result5](index.html) module"]
pub struct CHAN_RESULT5_SPEC;
impl crate::RegisterSpec for CHAN_RESULT5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [chan_result5::R](R) reader structure"]
impl crate::Readable for CHAN_RESULT5_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [chan_result5::W](W) writer structure"]
impl crate::Writable for CHAN_RESULT5_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CHAN_RESULT5 to value 0"]
impl crate::Resettable for CHAN_RESULT5_SPEC {
    #[inline(always)]
