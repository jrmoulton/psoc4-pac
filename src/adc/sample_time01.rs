...
#[doc = "Field `SAMPLE_TIME0` reader - Sample time0 (aperture) in ADC clock cycles"]
pub type SAMPLE_TIME0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `SAMPLE_TIME0` writer - Sample time0 (aperture) in ADC clock cycles"]
...
impl R {
    #[doc = "Bits 0:9 - Sample time0 (aperture) in ADC clock cycles"]
    #[inline(always)]
...
#[doc = "`reset()` method sets SAMPLE_TIME01 to value 0"]
