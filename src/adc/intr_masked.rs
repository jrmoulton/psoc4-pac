...
#[doc = "Register `INTR_MASKED` writer"]
pub struct W(crate::W<INTR_MASKED_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INTR_MASKED_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INTR_MASKED_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INTR_MASKED_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EOS_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASKED_SPEC, bool, 0>;
...
pub type OVERFLOW_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASKED_SPEC, bool, 1>;
...
pub type FW_COLLISION_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASKED_SPEC, bool, 2>;
...
pub type DSI_COLLISION_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASKED_SPEC, bool, 3>;
...
pub type INJ_EOC_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASKED_SPEC, bool, 4>;
...
pub type INJ_SATURATE_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASKED_SPEC, bool, 5>;
...
pub type INJ_RANGE_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASKED_SPEC, bool, 6>;
...
pub type INJ_COLLISION_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASKED_SPEC, bool, 7>;
impl R {
...
#[doc = "`write(|w| ..)` method takes [intr_masked::W](W) writer structure"]
impl crate::Writable for INTR_MASKED_SPEC {
    type Writer = W;
}
