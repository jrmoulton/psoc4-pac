...
pub type EOS_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, 0>;
...
pub type OVERFLOW_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, 1>;
...
pub type FW_COLLISION_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, 2>;
...
pub type DSI_COLLISION_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, 3>;
...
pub type INJ_EOC_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, 4>;
...
pub type INJ_SATURATE_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, 5>;
...
pub type INJ_RANGE_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, 6>;
...
pub type INJ_COLLISION_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_MASK_SPEC, bool, 7>;
impl R {
