#[doc = "Register `CHAN_CONFIG6` reader"]
pub struct R(crate::R<CHAN_CONFIG6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CHAN_CONFIG6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CHAN_CONFIG6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CHAN_CONFIG6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CHAN_CONFIG6` writer"]
pub struct W(crate::W<CHAN_CONFIG6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CHAN_CONFIG6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CHAN_CONFIG6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CHAN_CONFIG6_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PIN_ADDR_W<'a> = crate::FieldWriter<'a, u32, CHAN_CONFIG6_SPEC, u8, u8, 3, 0>;
...
pub type PORT_ADDR_W<'a> = crate::FieldWriter<'a, u32, CHAN_CONFIG6_SPEC, u8, u8, 3, 4>;
...
pub type DIFFERENTIAL_EN_W<'a> = crate::BitWriter<'a, u32, CHAN_CONFIG6_SPEC, bool, 8>;
...
pub type RESOLUTION_W<'a> = crate::BitWriter<'a, u32, CHAN_CONFIG6_SPEC, bool, 9>;
...
pub type AVG_EN_W<'a> = crate::BitWriter<'a, u32, CHAN_CONFIG6_SPEC, bool, 10>;
...
pub type SAMPLE_TIME_SEL_W<'a> = crate::FieldWriter<'a, u32, CHAN_CONFIG6_SPEC, u8, u8, 2, 12>;
...
pub type DSI_OUT_EN_W<'a> = crate::BitWriter<'a, u32, CHAN_CONFIG6_SPEC, bool, 31>;
impl R {
...
#[doc = "Channel6 configuration register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [chan_config6](index.html) module"]
pub struct CHAN_CONFIG6_SPEC;
impl crate::RegisterSpec for CHAN_CONFIG6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [chan_config6::R](R) reader structure"]
impl crate::Readable for CHAN_CONFIG6_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [chan_config6::W](W) writer structure"]
impl crate::Writable for CHAN_CONFIG6_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CHAN_CONFIG6 to value 0"]
impl crate::Resettable for CHAN_CONFIG6_SPEC {
    #[inline(always)]
