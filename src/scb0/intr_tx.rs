...
pub type TRIGGER_W<'a> = crate::BitWriter<'a, u32, INTR_TX_SPEC, bool, 0>;
...
pub type NOT_FULL_W<'a> = crate::BitWriter<'a, u32, INTR_TX_SPEC, bool, 1>;
...
pub type EMPTY_W<'a> = crate::BitWriter<'a, u32, INTR_TX_SPEC, bool, 4>;
...
pub type OVERFLOW_W<'a> = crate::BitWriter<'a, u32, INTR_TX_SPEC, bool, 5>;
...
pub type UNDERFLOW_W<'a> = crate::BitWriter<'a, u32, INTR_TX_SPEC, bool, 6>;
...
pub type BLOCKED_W<'a> = crate::BitWriter<'a, u32, INTR_TX_SPEC, bool, 7>;
...
pub type UART_NACK_W<'a> = crate::BitWriter<'a, u32, INTR_TX_SPEC, bool, 8>;
...
pub type UART_DONE_W<'a> = crate::BitWriter<'a, u32, INTR_TX_SPEC, bool, 9>;
...
pub type UART_ARB_LOST_W<'a> = crate::BitWriter<'a, u32, INTR_TX_SPEC, bool, 10>;
impl R {
