...
pub type I2C_ARB_LOST_W<'a> = crate::BitWriter<'a, u32, INTR_M_SPEC, bool, 0>;
...
pub type I2C_NACK_W<'a> = crate::BitWriter<'a, u32, INTR_M_SPEC, bool, 1>;
...
pub type I2C_ACK_W<'a> = crate::BitWriter<'a, u32, INTR_M_SPEC, bool, 2>;
...
pub type I2C_STOP_W<'a> = crate::BitWriter<'a, u32, INTR_M_SPEC, bool, 4>;
...
pub type I2C_BUS_ERROR_W<'a> = crate::BitWriter<'a, u32, INTR_M_SPEC, bool, 8>;
#[doc = "Field `SPI_DONE` reader - SPI master transfer done event: all data frames in the transmit FIFO are sent and the transmit FIFO and shift register are empty."]
pub type SPI_DONE_R = crate::BitReader<bool>;
#[doc = "Field `SPI_DONE` writer - SPI master transfer done event: all data frames in the transmit FIFO are sent and the transmit FIFO and shift register are empty."]
pub type SPI_DONE_W<'a> = crate::BitWriter<'a, u32, INTR_M_SPEC, bool, 9>;
impl R {
    ...
    #[doc = "Bit 9 - SPI master transfer done event: all data frames in the transmit FIFO are sent and the transmit FIFO and shift register are empty."]
    #[inline(always)]
