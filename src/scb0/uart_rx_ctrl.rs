...
pub type STOP_BITS_W<'a> = crate::FieldWriter<'a, u32, UART_RX_CTRL_SPEC, u8, u8, 3, 0>;
...
pub type PARITY_W<'a> = crate::BitWriter<'a, u32, UART_RX_CTRL_SPEC, bool, 4>;
...
pub type PARITY_ENABLED_W<'a> = crate::BitWriter<'a, u32, UART_RX_CTRL_SPEC, bool, 5>;
...
pub type POLARITY_W<'a> = crate::BitWriter<'a, u32, UART_RX_CTRL_SPEC, bool, 6>;
...
pub type DROP_ON_PARITY_ERROR_W<'a> = crate::BitWriter<'a, u32, UART_RX_CTRL_SPEC, bool, 8>;
...
pub type DROP_ON_FRAME_ERROR_W<'a> = crate::BitWriter<'a, u32, UART_RX_CTRL_SPEC, bool, 9>;
...
pub type MP_MODE_W<'a> = crate::BitWriter<'a, u32, UART_RX_CTRL_SPEC, bool, 10>;
...
pub type LIN_MODE_W<'a> = crate::BitWriter<'a, u32, UART_RX_CTRL_SPEC, bool, 12>;
...
pub type SKIP_START_W<'a> = crate::BitWriter<'a, u32, UART_RX_CTRL_SPEC, bool, 13>;
...
pub type BREAK_WIDTH_W<'a> = crate::FieldWriter<'a, u32, UART_RX_CTRL_SPEC, u8, u8, 4, 16>;
impl R {
