...
pub type TRIGGER_LEVEL_W<'a> = crate::FieldWriter<'a, u32, RX_FIFO_CTRL_SPEC, u8, u8, 8, 0>;
...
pub type CLEAR_W<'a> = crate::BitWriter<'a, u32, RX_FIFO_CTRL_SPEC, bool, 16>;
...
pub type FREEZE_W<'a> = crate::BitWriter<'a, u32, RX_FIFO_CTRL_SPEC, bool, 17>;
impl R {
