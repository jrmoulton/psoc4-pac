...
pub type WAKE_UP_W<'a> = crate::BitWriter<'a, u32, INTR_I2C_EC_SPEC, bool, 0>;
...
pub type EZ_STOP_W<'a> = crate::BitWriter<'a, u32, INTR_I2C_EC_SPEC, bool, 1>;
...
pub type EZ_WRITE_STOP_W<'a> = crate::BitWriter<'a, u32, INTR_I2C_EC_SPEC, bool, 2>;
...
pub type EZ_READ_STOP_W<'a> = crate::BitWriter<'a, u32, INTR_I2C_EC_SPEC, bool, 3>;
impl R {
