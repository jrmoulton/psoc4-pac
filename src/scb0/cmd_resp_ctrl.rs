...
pub type BASE_RD_ADDR_W<'a> = crate::FieldWriter<'a, u32, CMD_RESP_CTRL_SPEC, u16, u16, 9, 0>;
...
pub type BASE_WR_ADDR_W<'a> = crate::FieldWriter<'a, u32, CMD_RESP_CTRL_SPEC, u16, u16, 9, 16>;
impl R {
    ...
    #[doc = "Bits 16:24 - I2C/SPI read base address for CMD_RESP mode. Address is used by a I2C CMD_RESP mode write transfer (CTRL.MODE is I2C) or a SPI CMD_RESP mode write transfer (CTRL.MODE is SPI): at the start of a write transfer BASE_WE_ADDR is copied to CMD_RESP_STATUS.CURR_WR_ADDR. This field should not be modified during ongoing bus transfers."]
    #[inline(always)]
