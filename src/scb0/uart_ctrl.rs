...
pub type LOOPBACK_W<'a> = crate::BitWriter<'a, u32, UART_CTRL_SPEC, bool, 16>;
#[doc = "N/A\n\nValue on reset: 3"]
...
pub enum MODE_A {
    ...
    UART_SMARTCARD = 1,
    #[doc = "2: Infrared Data Association (IrDA) submode. Return to Zero modulation scheme. In this mode, the oversampling factor should be 16, that is OVS is 15."]
    UART_IRDA = 2,
}
...
pub type MODE_W<'a> = crate::FieldWriter<'a, u32, UART_CTRL_SPEC, u8, MODE_A, 2, 24>;
impl<'a> MODE_W<'a> {
