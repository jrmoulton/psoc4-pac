...
pub type EDGE0_SEL_W<'a> = crate::FieldWriterSafe<'a, u32, INTR_CFG_SPEC, u8, EDGE0_SEL_A, 2, 0>;
...
pub type EDGE1_SEL_W<'a> = crate::FieldWriter<'a, u32, INTR_CFG_SPEC, u8, u8, 2, 2>;
#[doc = "Field `EDGE2_SEL` reader - Sets which edge will trigger an IRQ for IO pad 2."]
pub type EDGE2_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EDGE2_SEL` writer - Sets which edge will trigger an IRQ for IO pad 2."]
pub type EDGE2_SEL_W<'a> = crate::FieldWriter<'a, u32, INTR_CFG_SPEC, u8, u8, 2, 4>;
#[doc = "Field `EDGE3_SEL` reader - Sets which edge will trigger an IRQ for IO pad 3."]
pub type EDGE3_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EDGE3_SEL` writer - Sets which edge will trigger an IRQ for IO pad 3."]
pub type EDGE3_SEL_W<'a> = crate::FieldWriter<'a, u32, INTR_CFG_SPEC, u8, u8, 2, 6>;
#[doc = "Field `EDGE4_SEL` reader - Sets which edge will trigger an IRQ for IO pad 4."]
pub type EDGE4_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EDGE4_SEL` writer - Sets which edge will trigger an IRQ for IO pad 4."]
pub type EDGE4_SEL_W<'a> = crate::FieldWriter<'a, u32, INTR_CFG_SPEC, u8, u8, 2, 8>;
#[doc = "Field `EDGE5_SEL` reader - Sets which edge will trigger an IRQ for IO pad 5."]
pub type EDGE5_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EDGE5_SEL` writer - Sets which edge will trigger an IRQ for IO pad 5."]
pub type EDGE5_SEL_W<'a> = crate::FieldWriter<'a, u32, INTR_CFG_SPEC, u8, u8, 2, 10>;
#[doc = "Field `EDGE6_SEL` reader - Sets which edge will trigger an IRQ for IO pad 6."]
pub type EDGE6_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EDGE6_SEL` writer - Sets which edge will trigger an IRQ for IO pad 6."]
pub type EDGE6_SEL_W<'a> = crate::FieldWriter<'a, u32, INTR_CFG_SPEC, u8, u8, 2, 12>;
#[doc = "Field `EDGE7_SEL` reader - Sets which edge will trigger an IRQ for IO pad 7."]
pub type EDGE7_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EDGE7_SEL` writer - Sets which edge will trigger an IRQ for IO pad 7."]
pub type EDGE7_SEL_W<'a> = crate::FieldWriter<'a, u32, INTR_CFG_SPEC, u8, u8, 2, 14>;
...
pub type FLT_EDGE_SEL_W<'a> =
    crate::FieldWriterSafe<'a, u32, INTR_CFG_SPEC, u8, FLT_EDGE_SEL_A, 2, 16>;
...
pub type FLT_SEL_W<'a> = crate::FieldWriter<'a, u32, INTR_CFG_SPEC, u8, u8, 3, 18>;
impl R {
    ...
    #[doc = "Bits 4:5 - Sets which edge will trigger an IRQ for IO pad 2."]
    #[inline(always)]
    pub fn edge2_sel(&self) -> EDGE2_SEL_R {
        EDGE2_SEL_R::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bits 6:7 - Sets which edge will trigger an IRQ for IO pad 3."]
    #[inline(always)]
    pub fn edge3_sel(&self) -> EDGE3_SEL_R {
        EDGE3_SEL_R::new(((self.bits >> 6) & 3) as u8)
    }
    #[doc = "Bits 8:9 - Sets which edge will trigger an IRQ for IO pad 4."]
    #[inline(always)]
    pub fn edge4_sel(&self) -> EDGE4_SEL_R {
        EDGE4_SEL_R::new(((self.bits >> 8) & 3) as u8)
    }
    #[doc = "Bits 10:11 - Sets which edge will trigger an IRQ for IO pad 5."]
    #[inline(always)]
    pub fn edge5_sel(&self) -> EDGE5_SEL_R {
        EDGE5_SEL_R::new(((self.bits >> 10) & 3) as u8)
    }
    #[doc = "Bits 12:13 - Sets which edge will trigger an IRQ for IO pad 6."]
    #[inline(always)]
    pub fn edge6_sel(&self) -> EDGE6_SEL_R {
        EDGE6_SEL_R::new(((self.bits >> 12) & 3) as u8)
    }
    #[doc = "Bits 14:15 - Sets which edge will trigger an IRQ for IO pad 7."]
    #[inline(always)]
