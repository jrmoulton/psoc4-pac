...
pub type CLOCK_SEL_W<'a> = crate::BitWriter<'a, u32, PUMP_CTRL_SPEC, bool, 0>;
#[doc = "Field `ENABLED` reader - 0=disabled: pump output is VDDA_PUMP, 1=enabled: pump output is boosted."]
pub type ENABLED_R = crate::BitReader<bool>;
#[doc = "Field `ENABLED` writer - 0=disabled: pump output is VDDA_PUMP, 1=enabled: pump output is boosted."]
pub type ENABLED_W<'a> = crate::BitWriter<'a, u32, PUMP_CTRL_SPEC, bool, 31>;
impl R {
    ...
    #[doc = "Bit 31 - 0=disabled: pump output is VDDA_PUMP, 1=enabled: pump output is boosted."]
    #[inline(always)]
