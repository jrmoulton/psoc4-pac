...
#[doc = "Field `SAMPLE_TIME0` reader - Sample time0 (aperture) in ADC clock cycles. Note that actual sample time is half a clock less than specified here. The minimum sample time is 194ns, which is 3.5 cycles (4 in this field) with an 18MHz clock. Minimum legal value in this register is 2."]
pub type SAMPLE_TIME0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `SAMPLE_TIME0` writer - Sample time0 (aperture) in ADC clock cycles. Note that actual sample time is half a clock less than specified here. The minimum sample time is 194ns, which is 3.5 cycles (4 in this field) with an 18MHz clock. Minimum legal value in this register is 2."]
pub type SAMPLE_TIME0_W<'a> = crate::FieldWriter<'a, u32, SAMPLE_TIME01_SPEC, u16, u16, 10, 0>;
...
pub type SAMPLE_TIME1_W<'a> = crate::FieldWriter<'a, u32, SAMPLE_TIME01_SPEC, u16, u16, 10, 16>;
impl R {
    #[doc = "Bits 0:9 - Sample time0 (aperture) in ADC clock cycles. Note that actual sample time is half a clock less than specified here. The minimum sample time is 194ns, which is 3.5 cycles (4 in this field) with an 18MHz clock. Minimum legal value in this register is 2."]
    #[inline(always)]
...
#[doc = "`reset()` method sets SAMPLE_TIME01 to value 0x0004_0004"]
