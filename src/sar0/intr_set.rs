...
pub type EOS_SET_W<'a> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, 0>;
...
pub type OVERFLOW_SET_W<'a> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, 1>;
...
pub type FW_COLLISION_SET_W<'a> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, 2>;
...
pub type DSI_COLLISION_SET_W<'a> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, 3>;
...
pub type INJ_EOC_SET_W<'a> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, 4>;
...
pub type INJ_SATURATE_SET_W<'a> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, 5>;
...
pub type INJ_RANGE_SET_W<'a> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, 6>;
...
pub type INJ_COLLISION_SET_W<'a> = crate::BitWriter<'a, u32, INTR_SET_SPEC, bool, 7>;
impl R {
