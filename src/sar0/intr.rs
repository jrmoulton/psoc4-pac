...
pub type EOS_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_SPEC, bool, 0>;
...
pub type OVERFLOW_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_SPEC, bool, 1>;
...
pub type FW_COLLISION_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_SPEC, bool, 2>;
...
pub type DSI_COLLISION_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_SPEC, bool, 3>;
...
pub type INJ_EOC_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_SPEC, bool, 4>;
#[doc = "Field `INJ_SATURATE_INTR` reader - Injection Saturation Interrupt: hardware sets this interrupt if an injection conversion result (before averaging) is either 0x000 or 0xFFF (for 12-bit resolution), this is an indication that the ADC likely saturated. Write with '1' to clear bit."]
pub type INJ_SATURATE_INTR_R = crate::BitReader<bool>;
#[doc = "Field `INJ_SATURATE_INTR` writer - Injection Saturation Interrupt: hardware sets this interrupt if an injection conversion result (before averaging) is either 0x000 or 0xFFF (for 12-bit resolution), this is an indication that the ADC likely saturated. Write with '1' to clear bit."]
pub type INJ_SATURATE_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_SPEC, bool, 5>;
...
pub type INJ_RANGE_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_SPEC, bool, 6>;
...
pub type INJ_COLLISION_INTR_W<'a> = crate::BitWriter<'a, u32, INTR_SPEC, bool, 7>;
impl R {
    ...
    #[doc = "Bit 5 - Injection Saturation Interrupt: hardware sets this interrupt if an injection conversion result (before averaging) is either 0x000 or 0xFFF (for 12-bit resolution), this is an indication that the ADC likely saturated. Write with '1' to clear bit."]
    #[inline(always)]
