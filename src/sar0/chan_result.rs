...
#[doc = "Field `CHAN_RESULT_VALID_MIR` reader - mirror bit of corresponding bit in SAR_CHAN_RESULT_VALID register"]
...
impl R {
    ...
    #[doc = "Bit 31 - mirror bit of corresponding bit in SAR_CHAN_RESULT_VALID register"]
    #[inline(always)]
