...
pub type OA1_PWR_MODE_W<'a> = crate::FieldWriter<'a, u32, OA_RES1_CTRL_SPEC, u8, u8, 2, 0>;
#[doc = "Field `OA1_DRIVE_STR_SEL` reader - Opamp1 output strenght select 0=1x, 1=10x"]
pub type OA1_DRIVE_STR_SEL_R = crate::BitReader<bool>;
#[doc = "Field `OA1_DRIVE_STR_SEL` writer - Opamp1 output strenght select 0=1x, 1=10x"]
pub type OA1_DRIVE_STR_SEL_W<'a> = crate::BitWriter<'a, u32, OA_RES1_CTRL_SPEC, bool, 2>;
...
pub type OA1_COMP_EN_W<'a> = crate::BitWriter<'a, u32, OA_RES1_CTRL_SPEC, bool, 4>;
...
pub type OA1_HYST_EN_W<'a> = crate::BitWriter<'a, u32, OA_RES1_CTRL_SPEC, bool, 5>;
...
pub type OA1_BYPASS_DSI_SYNC_W<'a> = crate::BitWriter<'a, u32, OA_RES1_CTRL_SPEC, bool, 6>;
...
pub type OA1_DSI_LEVEL_W<'a> = crate::BitWriter<'a, u32, OA_RES1_CTRL_SPEC, bool, 7>;
...
pub type OA1_COMPINT_W<'a> =
    crate::FieldWriterSafe<'a, u32, OA_RES1_CTRL_SPEC, u8, OA1_COMPINT_A, 2, 8>;
...
pub type OA1_PUMP_EN_W<'a> = crate::BitWriter<'a, u32, OA_RES1_CTRL_SPEC, bool, 11>;
impl R {
    #[doc = "Bits 0:1 - Opamp1 power level: see description of OA0_PWR_MODE"]
    #[inline(always)]
    pub fn oa1_pwr_mode(&self) -> OA1_PWR_MODE_R {
        OA1_PWR_MODE_R::new((self.bits & 3) as u8)
    }
    #[doc = "Bit 2 - Opamp1 output strenght select 0=1x, 1=10x"]
    #[inline(always)]
    pub fn oa1_drive_str_sel(&self) -> OA1_DRIVE_STR_SEL_R {
        OA1_DRIVE_STR_SEL_R::new(((self.bits >> 2) & 1) != 0)
    }
