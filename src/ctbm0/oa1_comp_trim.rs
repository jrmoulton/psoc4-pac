...
#[doc = "Field `OA1_COMP_TRIM` reader - Opamp 1 Compensation Capacitor Trim"]
pub type OA1_COMP_TRIM_R = crate::FieldReader<u8, u8>;
#[doc = "Field `OA1_COMP_TRIM` writer - Opamp 1 Compensation Capacitor Trim"]
pub type OA1_COMP_TRIM_W<'a> = crate::FieldWriter<'a, u32, OA1_COMP_TRIM_SPEC, u8, u8, 2, 0>;
impl R {
    #[doc = "Bits 0:1 - Opamp 1 Compensation Capacitor Trim"]
    #[inline(always)]
