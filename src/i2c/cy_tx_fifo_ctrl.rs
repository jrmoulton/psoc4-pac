#[doc = "Register `Cy_TX_FIFO_CTRL` reader"]
pub struct R(crate::R<CY_TX_FIFO_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CY_TX_FIFO_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CY_TX_FIFO_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CY_TX_FIFO_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `Cy_TX_FIFO_CTRL` writer"]
pub struct W(crate::W<CY_TX_FIFO_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CY_TX_FIFO_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CY_TX_FIFO_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CY_TX_FIFO_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TRIGGER_LEVEL` reader - Trigger level. When the transmitter FIFO has less entries than the amount of this field, a transmitter trigger event is generated."]
pub type TRIGGER_LEVEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TRIGGER_LEVEL` writer - Trigger level. When the transmitter FIFO has less entries than the amount of this field, a transmitter trigger event is generated."]
pub type TRIGGER_LEVEL_W<'a> = crate::FieldWriter<'a, u32, CY_TX_FIFO_CTRL_SPEC, u8, u8, 4, 0>;
...
pub type CLEAR_W<'a> = crate::BitWriter<'a, u32, CY_TX_FIFO_CTRL_SPEC, bool, 16>;
...
pub type FREEZE_W<'a> = crate::BitWriter<'a, u32, CY_TX_FIFO_CTRL_SPEC, bool, 17>;
impl R {
    #[doc = "Bits 0:3 - Trigger level. When the transmitter FIFO has less entries than the amount of this field, a transmitter trigger event is generated."]
    #[inline(always)]
...
#[doc = "Transmitter FIFO control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cy_tx_fifo_ctrl](index.html) module"]
pub struct CY_TX_FIFO_CTRL_SPEC;
impl crate::RegisterSpec for CY_TX_FIFO_CTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cy_tx_fifo_ctrl::R](R) reader structure"]
impl crate::Readable for CY_TX_FIFO_CTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cy_tx_fifo_ctrl::W](W) writer structure"]
impl crate::Writable for CY_TX_FIFO_CTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets Cy_TX_FIFO_CTRL to value 0"]
impl crate::Resettable for CY_TX_FIFO_CTRL_SPEC {
    #[inline(always)]
